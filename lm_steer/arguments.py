...
def parse_args():
    ...
    parser.add_argument("--num_steers", type=int, default=50)
    parser.add_argument("--temperature", type=int, default=1)
    parser.add_argument("--dummy_steer", action="store_true")
    ...
    parser.add_argument("--pos_neg_independent", action="store_true")
